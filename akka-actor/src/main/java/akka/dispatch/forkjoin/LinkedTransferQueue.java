...
public class LinkedTransferQueue<E> extends AbstractQueue<E>
   ...
   *     java.util.concurrent.BlockingQueue#offer(Object,long,TimeUnit) BlockingQueue.offer})
   * @throws NullPointerException if the specified element is null
   */
   ...
   * constrained.
   *
   * @return {@code Integer.MAX_VALUE} (as specified by {@link
   *     java.util.concurrent.BlockingQueue#remainingCapacity() BlockingQueue.remainingCapacity})
   */
